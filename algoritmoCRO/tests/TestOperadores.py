...
class TestOperadores( unittest.TestCase ):
    ...
    def test_randomRotate(self):
        array = [ 0, 0, 0, 1, 0, 0, 0, 1 ]
        n = 2
        new_array = randomRotate( array, { 'n' : n } )
        self.assertIsInstance( new_array, list )
     
    def test_splitInGroups(self):
        array = [ 1, 0, 0, 1 ]
        n = 2
        self.assertEqual( splitInGroups( array, { 'n' : n } ) , [ [ 1, 0], [ 0, 1 ] ] )

    def test_halfExchange(self):
        array1 = [ 1, 0, 0, 1 ]
        array2 = [ 0, 1, 1, 0 ]
        n = 2
        self.assertEqual( halfExchange( array1, array2, { 'n' : n}  ), [  0, 1, 0, 1 ] )

    def test_halfOddEven(self):
        array = [ 1, 0, 1, 0 ]
        n = 2
        new_array = halfOddEven( array, { 'n' : n } )
        # print( new_array )
